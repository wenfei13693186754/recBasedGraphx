...
object DataToJson extends Serializable {
   ...
   */
  def recResultRDDMapToJson(result: RDD[(Int, String, Map[String, Array[(String, Double)]])]): RDD[(Int, String, JSONObject)] = {
  ...
  def recResultRDDListToJson(
    recResult: RDD[(Int, String, Map[String, Array[(String, Double)]])]): RDD[(Int, String, Map[String, JSONArray])] =
    {
   ...
   */
  def mapToJson(data: Map[String,Array[(String, Double)]] ): JSONObject = {
   ...
   */
  def listToJson(data: Map[String, Array[(String, Double)]]): Map[String, JSONArray] = {
   ...
   */
  def listToJson(data: Array[(String, Double)]): JSONArray = {
    val jsonItems = new JSONArray 
